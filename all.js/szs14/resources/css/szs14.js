...
let productContainer = [{
    urlImage: 'trainer-1.jpg',
    content: 'DOM Practical 2 Slider #2',
}
,{
    urlImage: 'trainer-2.jpg',
    content: 'DOM Practical 2 Slider #3',
},
{
    urlImage: 'trainer-3.jpg',
...
let nextSlider = ()=>{
    ...
    hero__banner.style.backgroundImage = `url(resources/images/${productContainer[imgIndex].urlImage})`
